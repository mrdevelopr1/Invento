                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3 mt-3">
                            ...
                            <div class="form-group col-sm-10">
                                <input name="mobile_no" class="form-control" type="text" value="" >
                            </div>
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row mb-3 mt-3">
                            ...
                            <div class="col-sm-10">
                            <img id="showImage" class="rounded avatar-lg" alt="200x200" src="{{url('upload/no_image.jpg') }}" alt="Card image cap">
                            </div>
                        </div>
                        <!-- end row -->
