        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <a href="{{route('customer.add')}}" class="btn btn-secondary waves-effect waves-light" style="float:right;">Add Customer</a>
                    <br><br>

                        <h4 class="card-title">Customer All Data</h4><br>
