        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <a href="{{route('supplier.add')}}" class="btn btn-secondary waves-effect waves-light" style="float:right;">Add Supplier</a>
                    <br><br>

                        <h4 class="card-title">Supplier All Data</h4><br>
