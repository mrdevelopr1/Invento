                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div>
                                    <div class="p-2">
                                        <h3 class="font-size-16"><strong>Daily Invoice Report<span class="btn btn-info" style="margin-left: 10px;">{{ date('d-m-Y',strtotime($start_date)) }}</span> - <span class="btn btn-success">{{ date('d-m-Y',strtotime($end_date)) }}</span></strong></h3>
                                    </div>
                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $item['payment']['customer']['name'] ?? 'N/A' }}</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="no-line text-end"><h4 class="m-0">AED{{ $total_sum }}</h4></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
