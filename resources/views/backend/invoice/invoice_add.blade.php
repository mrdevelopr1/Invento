                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="md-3">
                                ...
                                <i class="btn btn-secondary waves-effect waves-light fas fa-plus-circle addeventmore"> <span style="font-family: sans-serif; font-weight: normal;"> Add More</span></i>
                            </div>
                        </div>
                    </div> <!-- end row  -->
                </div> <!-- End card-body -->
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-9">
                                <label> Customer Name  </label>
                                    <select name="customer_id" id="customer_id" class="form-select" require>
