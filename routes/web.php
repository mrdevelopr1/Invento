...
Route::middleware('auth')->group(function(){
    ...
    Route::controller(PurchaseController::class)->group(Function(){
        ...
        Route::get('/purchase/print/list','PrintPurchaseList')->name('print.purchaseList');
        ...
        Route::get('/purchase/print/{id}','PrintPurchase')->name('print.purchase');
    ...
    Route::controller(SalesController::class)->group(Function(){
        ...
        Route::get('/sales/invoice/report','DailySalesReport')->name('daily.sales.report');

        Route::get('/sales/invoice/pdf','DailySalesPdf')->name('daily.sales.pdf');
    });
